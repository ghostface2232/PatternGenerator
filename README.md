...
- **Export** — dimensioned SVG (mm units, entry/exit layers when taper is active, an outline group when the sheet is trimmed, a keep-out group for cutouts) and high-resolution PNG
