...
function valueNoise2D(x, y, seed) {
  ...
  const tx = fade(fract(x)), ty = fade(fract(y));
...
function fbm2D(x, y, seed, detail) {
  let value = 0, amplitude = 0.55, frequency = 1, total = 0;
...
export const VARIATION_PRESETS = {
  "Center Bloom": {
    minScale: 0.08, maxScale: 1.48,
    layer: { space: "Radial", profile: "Ramp", radius: 1.05, phase: 0, exponent: 1.7, centerX: 0.5, centerY: 0.5, invert: true },
  },
  "Linear Fade": {
    minScale: 0.1, maxScale: 1.45,
    layer: { space: "Linear", profile: "Ramp", angle: 0, phase: 0, exponent: 1.15, invert: false },
  },
  "Diagonal Wave": {
    minScale: 0.08, maxScale: 1.42,
    layer: { space: "Linear", profile: "Wave", angle: -35, frequency: 3.2, phase: 0.08, exponent: 1.35 },
  },
  "Concentric Pulse": {
    minScale: 0.12, maxScale: 1.45,
    layer: { space: "Radial", profile: "Wave", radius: 1.15, frequency: 4.2, phase: 0, exponent: 1.4 },
  },
  "Angular Fan": {
    minScale: 0.16, maxScale: 1.45,
    layer: { space: "Angular", profile: "Wave", angle: -90, frequency: 6, phase: 0.1, exponent: 1.75 },
  },
  "Organic Field": {
    minScale: 0.18, maxScale: 1.45,
    layer: { space: "Linear", profile: "Noise", angle: 20, frequency: 3.6, detail: 4, phase: 0.2, exponent: 1.45, seed: 8241 },
  },
  "Spiral Echo": {
    minScale: 0.12, maxScale: 1.45,
