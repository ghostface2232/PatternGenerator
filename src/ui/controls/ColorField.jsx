  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 3 }} onPointerDown={e => e.stopPropagation()}>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 4 }}>
        ...
        <input type="text" value={text} aria-label={label}
          onChange={e => {
          ...
          style={{ width: 68, height: 30, fontSize: 10, background: controlBg, color: textPrimary, border: `1px solid ${border}`, borderRadius: 5, padding: "0 6px", outline: "none", fontFamily: MONO, textTransform: "uppercase" }} />
      </div>
      {open && pos && (
