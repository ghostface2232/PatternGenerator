  ...
  return (
    ...
    >
      <div style={{ display: "grid", gridTemplateColumns: "1fr auto auto", gap: 5, marginBottom: 8 }}>
        <Select
          value=""
          placeholder="Load a field preset…"
        ...
        <button
          ...
          style={iconBtn({
            width: 30,
            height: undefined,
            color: history.canUndo ? theme.textPrimary : theme.textSecondary,
        ...
        <button
          ...
          style={iconBtn({
            width: 30,
            height: undefined,
            color: history.canRedo ? theme.textPrimary : theme.textSecondary,
        ...
        <>
          <div style={{ display: "flex", alignItems: "center", gap: 5, marginBottom: 12 }}>
            {variation.layers.map((l, index) => (
              <button
                key={l.id}
                onClick={() => history.live(current => ({ ...current, selectedLayerId: l.id }))}
                style={chip(variation.selectedLayerId === l.id, {
                  flex: 1,
                  height: 28,
                  display: "flex",
                  alignItems: "center",
            ...
            {variation.layers.length > 1 && (
              <button
                onClick={actions.removeSelectedVariationLayer}
          ...
          {variationAdvanced && (
            <div style={{ paddingTop: 9 }}>
              <div style={{ fontSize: 9, color: theme.textSecondary, marginBottom: 11, lineHeight: 1.5 }}>
                Direction, origin, reach, position &amp; curve live on the canvas handles. These are the extra
                modifiers.
              </div>
          ...
          {variationEditMode && (
            ...
            >
              ...
              <div style={{ opacity: 0.8, marginTop: 4 }}>
                Center snaps to the panel centre, edges &amp; corners; spread &amp; position to 0/25/50/75/100%; angles
                to 45°. Hold Shift to lock to a snap; otherwise it gently pulls in near one.
              </div>
